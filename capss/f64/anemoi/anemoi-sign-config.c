...
int get_config_lppc_smallwood(uint32_t variant, reg_perm_lppc_cfg_t** lppc_cfg, smallwood_t** sw) {
    ...
    if(variant == 0) {
        ...
        params.rho = 2;
        params.piop_nb_opened_evals = 2;
        params.opening_pow_bits = 4;
        params.beta = 3;
        ...
        params.decs_eta = 8;
        params.decs_pow_bits = 6;
        
    } else if(variant == 2) {
        params.batching_factor = 2;
        params.iv_size = 4;
        params.y_size = 4;

        params.tree_height1 = 10;
        params.tree_arity1 = 2;
        params.tree_height2 = 0;
        params.tree_arity2 = 0;
    ...
    *lppc_cfg = rperm_lppc_malloc_config(params.batching_factor, params.iv_size, params.y_size);
    ...
    if(sw != NULL) {
        ...
        smallwood_cfg_t sw_cfg = {
            ...
            .opening_pow_bits = params.opening_pow_bits,
